...
const char sVersion[] = "Open DHCP Server Version 1.84 Linux Build 1058";
...
MYDWORD alad(data9 *req)
{
	...
	{
		MYDWORD lease = req->lease ? req->lease : MY_MAX_TIME;
		MYDWORD rebind = req->rebind > lease ? req->rebind : lease;
